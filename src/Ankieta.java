...
public class Ankieta
{
    ...
    public Ankieta(int rok, int miesiac, int dzien, int ile_dni_pobytu, int ile_osob, int cena, Styl jaki_styl, Kolorystyka jaka_kolorystyka, Kierunek jaki_kierunek, boolean dostep_do_internetu)
    {
